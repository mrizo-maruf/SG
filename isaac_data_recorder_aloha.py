...
WARMUP_STEPS = 200
RENDER_SUBSTEPS = 50  # inner steps per saved frame for better visuals
...
keyframes_move = [
    ...
    {'time': 12, 'translation': [9.5, 1.5, 2], 'euler_angles': [0, 30, 120]},
    {'time': 20, 'translation': [9.5, 6.5, 2], 'euler_angles': [0, 30, 235]},
    {'time': 25, 'translation': [0.6, 6.5, 2], 'euler_angles': [0, 25, 315]},
